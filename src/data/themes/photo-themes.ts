...
export const photoThemes: PhotoTheme[] = [
  {
    ...
    entries: [
      ...
      { id: 'river', label: 'Fluss', imageUrl: img('photo-1504701954957-2010ec3bcec1') },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'horse', label: 'Pferd', imageUrl: img('photo-1553284965-83fd3e82fa5a') },
      ...
      { id: 'fox', label: 'Fuchs', imageUrl: img('photo-1516934024742-b461fba47600') },
      { id: 'rabbit', label: 'Hase', imageUrl: img('photo-1585110396000-c9ffd4e4b308') },
      { id: 'deer', label: 'Hirsch', imageUrl: img('photo-1485833077787-5e38e0553e08') },
      { id: 'owl', label: 'Eule', imageUrl: img('photo-1535083783855-76ae62b2914e') },
      { id: 'dolphin', label: 'Delfin', imageUrl: img('photo-1570481662006-a3a1374699e8') },
